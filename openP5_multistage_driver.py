...
#     p.add_argument("--data_dir", type=str, default="/home/zj/code/ml-10M100K/")
#     p.add_argument("--output_dir", type=str, default="./runs/openP5_ml10M100K")
#     p.add_argument(
#         "--mode",
#         type=str,
#         default="lora",
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output_dir", type=str, default="./runs/openP5_ml10M100K_multistage")
    p.add_argument(
        "--mode",
        type=str,
        default="lora",
    ...
    p.add_argument("--stages", default="f1,f2,f3,f4")
    p.add_argument("--pred_stages", type=str, default="f2,f3,f4,test")
